...
public partial class Win32
{
    ...
    /// window with the public const int CS_PARENTDC style bit receives a regular device context from the system's cache of device contexts. It does
    /// not give the child the parent's device context or device context settings. Specifying public const int CS_PARENTDC enhances an application's performance.
    /// </summary>
